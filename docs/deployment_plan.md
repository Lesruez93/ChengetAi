...
`proposal/ChengetAI_AI4I_Proposal_Development.md` (Sections 2, 3, 5) and `docs/architecture.md`;
this page pulls them into the required checklist shape so reviewers don't have to reconstruct it.
