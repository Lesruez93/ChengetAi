...
class _SentinelScreenState extends State<SentinelScreen> {
  ...
  Future<void> _analyze() async {
    ...
    try {
      // The market is recorded on the job for reporting, and decides the
      // currency each flagged amount comes back labelled with — without it the
      // results render unlabelled. The detection rules themselves are
      // currency-agnostic: structuring and rapid reversals look the same in
      // naira as in shillings.
