      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            // Symbols alone are ambiguous across markets ("$" is not only USD),
            // so a reviewer working a flagged row sees the ISO code spelled out.
            if (transaction.currencyCode.isNotEmpty)
              _DetailRow(label: 'Currency', value: transaction.currencyCode),
